...
export async function PUT(req, { params }) {
  try {
    ...
    console.log("productSlug3", formData.get("productSlug"))
...
export async function DELETE(request, { params }) {
  try {
    ...
    const { id } = params; // ✅ Correct way to get the dynamic route param
    ...
    return NextResponse.json({ success: true, productDeleted });
  } catch (error) {
    return NextResponse.json(
